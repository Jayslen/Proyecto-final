...
namespace CapaPresentacion {
    ...
    public partial class ServicesDataSet : global::System.Data.DataSet {
        ...
        public partial class servicesDataTable : global::System.Data.TypedTableBase<servicesRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public servicesRow AddservicesRow(string service_name, string description, double price, double duration) {
        ...
        public partial class servicesRow : global::System.Data.DataRow {
            ...
            public double duration {
                get {
                    try {
                        return ((double)(this[this.tableservices.durationColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace CapaPresentacion.ServicesDataSetTableAdapters {
    ...
    public partial class servicesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[services] ([service_name], [description], [price], [duration])" +
                " VALUES (@service_name, @description, @price, @duration);\r\nSELECT service_id, se" +
                "rvice_name, description, price, duration FROM services WHERE (service_id = SCOPE" +
                "_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[services] SET [service_name] = @service_name, [description] = @description, [price] = @price, [duration] = @duration WHERE (([service_id] = @Original_service_id) AND ((@IsNull_service_name = 1 AND [service_name] IS NULL) OR ([service_name] = @Original_service_name)) AND ((@IsNull_description = 1 AND [description] IS NULL) OR ([description] = @Original_description)) AND ((@IsNull_price = 1 AND [price] IS NULL) OR ([price] = @Original_price)) AND ((@IsNull_duration = 1 AND [duration] IS NULL) OR ([duration] = @Original_duration)));
SELECT service_id, service_name, description, price, duration FROM services WHERE (service_id = @service_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT service_id, service_name, description, price, duration FROM dbo.services";
        ...
        public virtual int Delete(int Original_service_id, string Original_service_name, string Original_description, global::System.Nullable<double> Original_price, global::System.Nullable<double> Original_duration) {
            ...
            if ((Original_duration.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[8].Value = ((double)(Original_duration.Value));
            }
            else {
        ...
        public virtual int Insert(string service_name, string description, global::System.Nullable<double> price, global::System.Nullable<double> duration) {
        ...
        public virtual int Update(string service_name, string description, global::System.Nullable<double> price, global::System.Nullable<double> duration, int Original_service_id, string Original_service_name, string Original_description, global::System.Nullable<double> Original_price, global::System.Nullable<double> Original_duration, int service_id) {
            if ((service_name == null)) {
            ...
            if ((Original_duration.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((double)(Original_duration.Value));
            }
            else {
                this.Adapter.UpdateCommand.Parameters[11].Value = ((object)(1));
                this.Adapter.UpdateCommand.Parameters[12].Value = global::System.DBNull.Value;
            }
            this.Adapter.UpdateCommand.Parameters[13].Value = ((int)(service_id));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string service_name, string description, global::System.Nullable<double> price, global::System.Nullable<double> duration, int Original_service_id, string Original_service_name, string Original_description, global::System.Nullable<double> Original_price, global::System.Nullable<double> Original_duration) {
            return this.Update(service_name, description, price, duration, Original_service_id, Original_service_name, Original_description, Original_price, Original_duration, Original_service_id);
        }
    }
